...
class Car{
    constructor(make,mode,year,isAvailable){
        this.make=make
        this.year=year
        this.mode=mode
...
let car1=new Car("Toyota","Cammy",2020,true)
console.log({car1});
...
const rental = new Rental(car, "Diana Owiti", "2023-05-03", "2023-05-08");
...
const question = new Question("Which county is the cleanest?", ["Mombasa", "Nakuru", "Nairobi", "Kisumu"], "Nakuru");
